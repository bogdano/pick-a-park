		...
		jsonData := `[
			{
				...
				"updated": "2024-07-15 02:34:22.933Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2024-07-18 21:56:30.006Z",
				"name": "nationalParks",
				"type": "base",
				"system": false,
				"schema": [
				...
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_PzgvPoY` + "`" + ` ON ` + "`" + `nationalParks` + "`" + ` (` + "`" + `parkCode` + "`" + `)"
				],
				"listRule": null,
				"viewRule": null,
				"createRule": null,
			...
			},
			{
				...
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_gewiEhk` + "`" + ` ON ` + "`" + `campgrounds` + "`" + ` (` + "`" + `campId` + "`" + `)"
				],
				"listRule": null,
				"viewRule": null,
				"createRule": null,
			...
			{
				"id": "oz5jwa791jbf02k",
				"created": "2024-07-23 18:19:53.990Z",
				"updated": "2024-07-23 18:22:46.380Z",
				"name": "uniquePlaces",
				"type": "view",
				"system": false,
				"schema": [
				...
				"deleteRule": null,
				"options": {
					"query": "SELECT DISTINCT places.id, places.` + "`" + `placeName` + "`" + `\nFROM places\nJOIN placeParks ON places.id = placeParks.place\n"
				}
			}
		]`
